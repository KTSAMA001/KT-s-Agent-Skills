...
**分类**：图形学 > 距离场
**关键词**：#SDF #signed-distance-field #distance-field
...
**分类**：图形学 > 距离场 > 算法
**关键词**：#SDF #8ssedt #algorithm #dynamic-programming
**来源**：TaTa 仓库 - SDF/SDF-8ssedt.md
**来源日期**：2020-12-18
**收录日期**：2026-01-31
**可信度**：⭐⭐⭐⭐ (技术博客 + 代码验证)
...
**分类**：图形学 > 距离场 > 应用
**关键词**：#SDF #bitmap #anti-aliasing #resolution
**来源**：TaTa 仓库 - SDF/SDF-8ssedt.md
**来源日期**：2020-12-18
**收录日期**：2026-01-31
**可信度**：⭐⭐⭐⭐ (技术博客 + 实践验证)
...
**分类**：图形学 > 距离场 > 应用
**关键词**：#SDF #lerp #smooth-transition #toon-rendering
**来源**：TaTa 仓库 - SDF/SDF-8ssedt.md
**来源日期**：2020-12-18
**收录日期**：2026-01-31
**可信度**：⭐⭐⭐⭐ (技术博客 + 实践验证)
