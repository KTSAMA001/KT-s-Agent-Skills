...
**分类**：图形学 > 渲染 > PBR
**关键词**：#PBR #BRDF #Cook-Torrance #GGX #Fresnel #光照模型
...
- [渲染管线基础](./rendering-pipeline.md)
- [色彩空间](./color-space.md)
- [HLSL 语法](./hlsl-syntax.md)
